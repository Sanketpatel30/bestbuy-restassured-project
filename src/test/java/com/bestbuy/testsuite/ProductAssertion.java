...
public class ProductAssertion {
    ...
    public static void inIt() {
        ...
        response = given().when().get("/products").then().statusCode(200);
    }
    ...
    public void test0018() {
        response.body("data.[6]", Matchers.equalTo("Duracell - D Batteries (4-Pack)"));
    }
    ...
    @Test
    public void test20() {
        response.body("data.findAll{it.id==346575}.categories.size()", equalTo(4));
    }
}
